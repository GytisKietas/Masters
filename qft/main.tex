...
\usepackage{slashed} %For dirac slashed notation
\usepackage{tikz-feynman} %For contractions
...
\include{chapters/1. Classical Field Theory}

\include{chapters/2. Canonical quantisation}

\include{chapters/3. Interacting fields}

\include{chapters/4. The Dirac Equation}

\include{chapters/5. Quantizing the Dirac Field}

\include{chapters/6. Quantum Electrodynamics}
