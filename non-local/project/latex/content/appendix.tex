...
This appendix include the code written for this project

Script which solves and optimises ODE's
...
print(f"alpha  = {alpha:.4f} per day")
print(f"gamma  = {gamma:.4f} per day")
print(f"delta  = {delta:.4f} per day")
...
This script runs Monte carlo with Gillespie algorithm
