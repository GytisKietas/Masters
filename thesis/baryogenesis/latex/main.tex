...
\usepackage{float} %For forcing figures to be "here" [H]
...
%Define new Formating for special text here
...
% \Definition[Name]{number}{text}
% - The optional [Name] defaults to "Definition"
% - {number} is what appears after the name (e.g., "1.1")
% - {text} is the content of the definition
...
\include{sections/equations_of_motion}

\include{sections/simpler_equations}

\include{sections/strategy}

\include{sections/January}

\include{sections/February}
